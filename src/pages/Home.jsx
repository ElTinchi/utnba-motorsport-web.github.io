...
//
// keyPoints va de 1 a 0 porque el auto recorre el circuito en sentido inverso
// al del trazado. El perfil no es el de antes dado vuelta: se recalculó sobre
// la curvatura en el nuevo sentido, porque si no las frenadas caían a la
// salida de la curva en vez de la entrada.
//
// Si se toca TRACK_PATH hay que volver a generar estos dos arrays.
const CAR_KEY_POINTS =
  '1.0000;0.9889;0.9778;0.9667;0.9556;0.9444;0.9333;0.9222;0.9111;0.9000;0.8889;0.8778;0.86' +
  '67;0.8556;0.8444;0.8333;0.8222;0.8111;0.8000;0.7889;0.7778;0.7667;0.7556;0.7444;0.7333;0' +
  '.7222;0.7111;0.7000;0.6889;0.6778;0.6667;0.6556;0.6444;0.6333;0.6222;0.6111;0.6000;0.588' +
  '9;0.5778;0.5667;0.5556;0.5444;0.5333;0.5222;0.5111;0.5000;0.4889;0.4778;0.4667;0.4556;0.' +
  '4444;0.4333;0.4222;0.4111;0.4000;0.3889;0.3778;0.3667;0.3556;0.3444;0.3333;0.3222;0.3111' +
  ';0.3000;0.2889;0.2778;0.2667;0.2556;0.2444;0.2333;0.2222;0.2111;0.2000;0.1889;0.1778;0.1' +
  '667;0.1556;0.1444;0.1333;0.1222;0.1111;0.1000;0.0889;0.0778;0.0667;0.0556;0.0444;0.0333;' +
  '0.0222;0.0111;0.0000';

const CAR_KEY_TIMES =
  '0.0000;0.0163;0.0277;0.0369;0.0452;0.0534;0.0617;0.0699;0.0781;0.0863;0.0945;0.1028;0.11' +
  '10;0.1192;0.1274;0.1356;0.1439;0.1521;0.1603;0.1685;0.1768;0.1876;0.1976;0.2107;0.2226;0' +
  '.2387;0.2535;0.2663;0.2795;0.2909;0.3033;0.3177;0.3323;0.3477;0.3621;0.3770;0.3930;0.404' +
  '5;0.4149;0.4243;0.4341;0.4446;0.4566;0.4662;0.4753;0.4836;0.4918;0.5001;0.5090;0.5197;0.' +
  '5350;0.5465;0.5573;0.5670;0.5753;0.5836;0.5928;0.6017;0.6130;0.6231;0.6324;0.6415;0.6497' +
  ';0.6580;0.6662;0.6744;0.6828;0.6921;0.7086;0.7274;0.7395;0.7491;0.7575;0.7657;0.7739;0.7' +
  '822;0.7917;0.8054;0.8167;0.8299;0.8404;0.8518;0.8660;0.8876;0.9048;0.9293;0.9444;0.9607;' +
  '0.9724;0.9847;1.0000';
